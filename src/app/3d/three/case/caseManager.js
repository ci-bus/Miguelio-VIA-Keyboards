...
const shadowPath = "../../assets/dist/shadow-key-noise.png";
const noisePath = "../../assets/dist/noise.png";
const brushedRoughness = "../../assets/dist/brushed-metal_roughness-512.png";
const brushedAlbedo = "../../assets/dist/brushed-metal_albedo-512.png";
const brushedAo = "../../assets/dist/brushed-metal_ao-512.png";

const shadow_path_100 = "../../assets/shadows/100.png";
const shadow_path_40 = "../../assets/shadows/40.png";
const shadow_path_60 = "../../assets/shadows/60.png";
const shadow_path_60hhkb = "../../assets/shadows/60hhkb.png";
const shadow_path_60iso = "../../assets/shadows/60iso.png";
const shadow_path_60wkl = "../../assets/shadows/60wkl.png";
const shadow_path_65 = "../../assets/shadows/65.png";
const shadow_path_75 = "../../assets/shadows/75.png";
const shadow_path_80 = "../../assets/shadows/80.png";
const shadow_path_95 = "../../assets/shadows/95.png";
const shadow_path_leftnum = "../../assets/shadows/leftnum.png";
const shadow_path_numpad = "../../assets/shadows/numpad.png";
const shadow_path_40ortho = "../../assets/shadows/40ortho.png";
const shadow_path_50ortho = "../../assets/shadows/50ortho.png";

const nx = "../../assets/dist/nx.jpg";
const ny = "../../assets/dist/ny.jpg";
const nz = "../../assets/dist/nz.jpg";
const px = "../../assets/dist/px.jpg";
const py = "../../assets/dist/py.jpg";
const pz = "../../assets/dist/pz.jpg";
